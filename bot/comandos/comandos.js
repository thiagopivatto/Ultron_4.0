export function comandosInfo(botInfo){
    ...
    const comandos = {
        ...
        utilidades: {
            ...
            chat : {
                descricao: '',
                guia: `Ex: *${prefixo}chat* texto - Recebe uma resposta do CHAT GPT de acordo com o texto.\n`,
                msgs: {
                    resposta: "{p1}"
                }
            },
        ...
        diversao: {
            ...
            jacometro: {
                descricao: '',
                guia: `Ex: *${prefixo}jacometro* @membro - Mede o nível de Jacó do membro mencionado.\n\n`+
            ...
            fernandometro: {
                descricao: '',
                guia: `Ex: *${prefixo}fernandometro* @membro - Mede o nível de Nerfandes do membro mencionado.\n\n`+
            ...
            bolometro: {
                descricao: '',
                guia: `Ex: *${prefixo}bolometro* @membro - Mede o nível de bolagem do membro mencionado.\n\n`+
                `Ex: Responder com *${prefixo}bolometro* - Mede o nível de bolagem do membro respondido.\n`,
                msgs: {
                    respostas : [' 0%\n\n - PUTSA LA MISARIA',
                    '\n⚽  10% \n\n - NOUSSA VÉIO',
            ...
            chance: {
                descricao: '',
                guia: `Ex: *${prefixo} ficar rico* - Calcula sua chance de um tema aleatório a sua escolha.\n`,
                msgs: {
                    resposta: "🧩 *CHANCE* - Você tem *{p1}%* de chance de {p2}"
                }
            }, 
            fch: {
                descricao: '',
            ...
            trisal: {
                descricao: '',
                guia: `Ex: *${prefixo}trisal* Seleciona aleatoriamente um trisal. \n`,
                minimo: "[❗] O grupo deve ter no mínimo 3 membros para usar este comando.",
                msgs: {
                    resposta: "👩‍❤️‍👨 TRISAL - @{p1} , @{p2} & @{p3}"
                }
            },
            top: {
                descricao: '',
            ...
            vod: {
                descricao: '',
                guia: `Ex: *${prefixo}vod* - [vdd-dsf] [1-5]* - Verdade ou desafio.\n`,
                msgs: {
                    resposta: "🧩 *VERDADE OU DESAFIO* - {p1}"
                }
            },
        },
        //COMANDOS DOWNLOADS
        ...
        grupo: {
            ...
            mta: {
                descricao: '',
                guia: `Ex: *${prefixo}mta* - Marca todos os *MEMBROS/ADMIN* do grupo anonimamente com a mensagem 'ATENÇÃO'.\n\n` +
                      `Ex: *${prefixo}mta* mensagem - Marca todos os *MEMBROS/ADMIN* do grupo anonimamente com uma mensagem específica.\n`,
                msgs: {
                    resposta: "*ATENÇÃO!*",
                    resposta_motivo: "{p1}"
                }
