...
|- *${prefixo}mta* [mensagem] - Marca todos MEMBROS com uma mensagem de forma anônima.
...
|- *${prefixo}alterarcont* - Altera a quantidade de mensagens enviadas pelo membro selecionado.
